...
INSERT INTO tasks(category_id, title, closing_date, progress, memo) VALUES(2, 'A社打合せ資料作成', '2024-05-01', 0, 'お得意先');
INSERT INTO tasks(category_id, title, closing_date, progress, memo) VALUES(1, '部内M資料作成', '2024-05-29', 2, '早めにやろう');
