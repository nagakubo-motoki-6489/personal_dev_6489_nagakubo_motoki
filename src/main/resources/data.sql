...
-- ユーザーテーブルデータ
INSERT INTO users ( email, name, password) VALUES('tanaka@aaa.com', '田中太郎', 'himitu');
...
INSERT INTO tasks(category_id, title, closing_date, progress, memo) VALUES(3, '備品発注', '2024-05-24', 1, '石鹸');
